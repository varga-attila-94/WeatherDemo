...
import hu.attila.varga.weatherdemo.utils.Utils.Companion.LAT
import hu.attila.varga.weatherdemo.utils.Utils.Companion.LON
...
class MainActivityViewModel(val app: Application) : AndroidViewModel(app) {
    ...
    fun getCurrentWeather() {
        service.getWeather(LAT, LON, OPEN_WEATHER_MAP_API_KEY).enqueue(object : Callback<CurrentWeatherResponse> {
    ...
    private fun getForecast() {
        service.getForecast(LAT, LON, EXCLUDE_VALUES, OPEN_WEATHER_MAP_API_KEY)
